...
import logoKry from '@/images/logos/kry.svg'
import logoLix from '@/images/logos/lix.png'
import logoSeldon from '@/images/logos/seldon.png'
...
function Role({ role }: { role: Role }) {
  ...
  return (
    <li className="flex gap-4">
      <div className="relative mt-1 flex h-10 w-10 flex-none items-center justify-center rounded-md shadow-md ring-1 shadow-zinc-800/5 ring-zinc-900/5 dark:ring-white/10 bg-zinc-200 dark:bg-zinc-400 p-2">
        <div className="relative h-full w-full">
          <Image src={role.logo} alt="" className="object-contain" fill unoptimized />
        </div>
      </div>
...
function Resume() {
  ...
  return (
    <div className="rounded-2xl border border-zinc-100 p-6 dark:border-zinc-700/40">
      ...
      <Button href="/Andy-Huynh-CV.pdf" variant="secondary" className="group mt-6 w-full" download>
        Download CV
      ...
      <Container className="mt-9">
        <div className="max-w-2xl">
          <h1 className="text-4xl font-bold tracking-tight text-zinc-800 sm:text-5xl dark:text-zinc-100">
            Software Engineer, ex-neonatal nurse, and amateur fitness fanatic.
          </h1>
          <p className="mt-6 text-base text-zinc-600 dark:text-zinc-400">
            I'm Andy, a software engineer and ex-neonatal nurse based in London. I specialise in building out beautiful user interfaces using modern front-end technologies and staying up-to-date with current tech trends.
          </p>
          <div className="mt-6 flex gap-6">
            <SocialLink
              href="https://github.com/andy-h1"
              aria-label="Follow on GitHub"
              icon={GitHubIcon}
            />
            <SocialLink
              href="https://www.linkedin.com/in/andyhuynh1/"
